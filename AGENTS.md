...
This file is the quick-reference operating contract for toml-edit-kotlin. The longer
...
toml-edit-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`toml_edit`](https://crates.io/crates/toml_edit). Upstream Rust is the behavioral oracle while the
