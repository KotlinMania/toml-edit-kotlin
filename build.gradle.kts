...
kotlin {
    ...
    val xcf = XCFramework("TomlEdit")

    macosArm64 {
        binaries.framework { baseName = "TomlEdit"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "TomlEdit"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "TomlEdit"
        flattenPackage = "io.github.kotlinmania.tomledit"
    }

    android {
        namespace = "io.github.kotlinmania.tomledit"
...
mavenPublishing {
    ...
    coordinates(group.toString(), "toml-edit-kotlin", version.toString())

    pom {
        name.set("toml-edit-kotlin")
        description.set("Kotlin Multiplatform port of toml-rs/toml - Yet another format-preserving TOML parser")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/toml-edit-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/toml-edit-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/toml-edit-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/toml-edit-kotlin.git")
        }
    }
}
...
dependencies {
    ...
    codeqlAndroidAar("io.github.kotlinmania:anstyle-kotlin-android:0.1.5")
}
...
val codeqlCompileJvm = tasks.register<JavaExec>("codeqlCompileJvm") {
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            val sentinelFile =
                sentinelDir.get().asFile.resolve("io/github/kotlinmania/tomledit/CodeqlEmptySentinel.kt")
...
val fullTargetBuildTasks = listOf(
    ...
    "embedSwiftExportForXcode",
    "swiftExportTest",
    "assembleTomlEditXCFramework",
    "assembleTomlEditDebugXCFramework",
    "assembleTomlEditReleaseXCFramework",
    "assembleDebugIosFatFrameworkForTomlEditXCFramework",
    "assembleReleaseIosFatFrameworkForTomlEditXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForTomlEditXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForTomlEditXCFramework",
    "assembleDebugMacosFatFrameworkForTomlEditXCFramework",
    "assembleReleaseMacosFatFrameworkForTomlEditXCFramework",
    "assembleDebugTvosFatFrameworkForTomlEditXCFramework",
    "assembleReleaseTvosFatFrameworkForTomlEditXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForTomlEditXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForTomlEditXCFramework",
    "assembleDebugWatchosFatFrameworkForTomlEditXCFramework",
    "assembleReleaseWatchosFatFrameworkForTomlEditXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForTomlEditXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForTomlEditXCFramework",
